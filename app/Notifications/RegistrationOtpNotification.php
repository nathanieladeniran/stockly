...
class RegistrationOtpNotification extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ...
            ->line("**{$this->otp}**") // Make the OTP bold
            ->line('This OTP expires in 10 minutes. Do not share it with anyone.')
            ->action('Verify Account', url('/verify')) // Optional: Add a CTA button
