...
trait Translatable
{
     ...
     * @return array
     */
    public function translateMessageToArray(string $message, array $attributes = [], ?string $path_prefix = null): array
    {
     ...
     */
    public function hasTranslationKey(string $key): bool
    {
        return Lang::has($key);
    }
}
