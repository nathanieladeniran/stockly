...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->mediumInteger('otp_from_email')->nullable()->comment('OTP sent to email');
            $table->mediumInteger('otp_from_phone')->nullable()->comment('OTP sent to mobile number');
            ...
            $table->string('referral_token')->unique()->nullable()->comment('Personal referral token');
            $table->json('kyc_response')->nullable();
            $table->timestamp('kyc_profile_at')->nullable();
